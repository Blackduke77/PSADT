...
$adtSession = @{
    ...
    AppScriptDate = '2025-04-07'
    AppScriptAuthor = 'Blackduke77'
...
function Install-ADTDeployment
{
    ...
    Show-ADTInstallationWelcome -AllowDefer -DeferTimes 3 -CheckDiskSpace -PersistPrompt

    ## Show Progress Message (with the default message).
    Show-ADTInstallationProgress -StatusMessage "Installing Any Existing Versions of Microsoft Windows .NET Desktop Runtime 6.0. Please Wait..."
    ...
    Start-ADTProcess -FilePath windowsdesktop-runtime-6.0.36-win-x86.exe -ArgumentList "/install /quiet /norestart"
    Start-ADTProcess -FilePath windowsdesktop-runtime-6.0.36-win-x64.exe -ArgumentList "/install /quiet /norestart"
    ...
    if (!$adtSession.UseDefaultMsi)
    {
        Show-ADTInstallationPrompt -Message '.NET 6 Runtime installed sucessfully.' -ButtonRightText 'OK' -Icon Information -NoWait
    }
}
...
function Uninstall-ADTDeployment
{
    ...
    ## Show Progress Message (with the default message).
    Show-ADTInstallationProgress -StatusMessage "Uninstalling Any Existing Versions of Microsoft Windows .NET Desktop Runtime 6.0. Please Wait..."
    ...
    ## Uninstall Any Existing Version of Microsoft Windows .NET Desktop Runtime 6.0
    ...
    {
    Write-ADTLogEntry -Message "Found $($Runtime.FullName), now attempting to uninstall $installTitle."
    Start-ADTProcess -FilePath "$Runtime" -ArgumentList "/uninstall /quiet /norestart /log C:\Windows\Logs\Software\NETDesktopRuntime60-Uninstall.log" -WindowStyle Hidden
